...
function draw() {
  ...
  if (gameStateflag === 3) {
    ...
    image(wall_i, width - 600, height - 500, 1300, 400);
    image(wall2_i, width - 260, height - 150, 350, 300);
image(wall2_i,width-400,height-80,20,2300)
image(wall2_i,width-110,height-155,20,9200)
image(wall2_i,width-1100,height-155,20,9200);
...
text('Press the w key to go to the main map.', width - 250,300)
     if (keyDown('w')){
       gameStateflag = 3;
       document.getElementById('level').style.display = 'inline';
...
text('Press the w key to go to the main map.', width - 250,300)
  ...
  if (gameStateflag === 21) {
    ...
    if (fruit_katana_gameStates2 === "TEXT") {
      textFont("inconsolata");
      fill("blue")
      text("Welcome to the game of fruit ninja.", width - 250, 200);
      text("Hope that you enjoy the game and all the best for winning", width - 300, 220)
    ...
    if (fruit_katana_gameStates2 === "PLAY") {
      ...
      if (fruit_ninja_score > 9) {
        fruit_katana_gameStates2 = "WINNER";
        sword.visible = 0;
        audio2.play();
        audio2.setVolume(0.3);
        fruitG.setVisibleEach(0);
    ...
    if (fruit_katana_gameStates2 === "OVER") {
      textSize(20);
      textAlign(CENTER);
      textFont("inconsolata");
      fill("ghostwhite");
    ...
    if (fruit_katana_gameStates2 === "WINNER") {
      textFont("Georgia");
      textSize(20);
      fill("white");
     text("YOU_WINN!!!", width - 250, 200);
